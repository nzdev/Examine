...
namespace Examine.Lucene.Providers
{
    ...
    public class LuceneSearcher : BaseLuceneSearcher, IDisposable
    {
        ...
        public LuceneSearcher(string name, SearcherManager searcherManager, Analyzer analyzer, FieldValueTypeCollection fieldValueTypeCollection, FacetsConfig facetsConfig, SimilarityDefinitionCollection similarityDefinitionCollection)
